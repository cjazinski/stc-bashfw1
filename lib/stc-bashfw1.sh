...
declare __oo__libPath="$( cd "${BASH_SOURCE[0]%/*}" && pwd )"
declare __oo__path="${__oo__libPath}/.."
declare __oo__importedFiles
...
trap "__EXCEPTION_TYPE__=\"\$_\" error_exit \$BASH_COMMAND" ERR
